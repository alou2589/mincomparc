...
class AgentModel {
  ...
  AgentModel({this.id,this.prenom,this.nom,this.poste_id,this.sous_structure_id,this.type_agent_id,this.date_naissance,this.lieu_naissance,this.telephone,this.genre
  });

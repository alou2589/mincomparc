  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            // An icon button for a search action
            color: Colors.white,
          ...
          PopupMenuButton<Text>(
            // A popup menu button for additional menu options
            color: Colors.white,
            itemBuilder: (context) {
              // A method that returns the menu options as widgets
              return [
                const PopupMenuItem(
                  // A menu item widget with the text "Menu 1"
                  child: Text(
                    'Profil',
                ...
                const PopupMenuItem(
                  // A menu item widget with the text "Menu 2"
                ...
                PopupMenuItem(
                  // A menu item widget with the text "Menu 3"
                  onTap: () {
                    UserModel.logout();

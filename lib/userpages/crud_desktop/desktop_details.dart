...
import 'package:mincomparc/userpages/crud_attribution/attribution_details.dart';
...
class DesktopDetails extends StatefulWidget {
  const DesktopDetails({super.key, required this.matosModel});
...
class _DesktopDetailsState extends State<DesktopDetails> {
  String nom_type_matos="Ordinateur Fixe";
  String marque_matos="";
  String modele_matos="";
  String sn_matos="";
  ...
  getInfo() async{
    var data=await Info.getInfoAllDesktop(widget.matosModel.id.toString());

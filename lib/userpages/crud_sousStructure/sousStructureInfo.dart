import 'package:mincomparc/userpages/crud_sousStructure/sous_structure_details.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Row(
        ...
        children: [
          Text(
            "${sousStructures.length} ",
            style: const TextStyle(
                fontWeight: FontWeight.bold, color: Colors.teal, fontSize: 20),
          ),
          sousStructures.length <= 1
              ? const Text("sous-structure")
              : const Text("sous-structures"),
        ],
      ),
      Expanded(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SousStructureDetails(
                                  sousStructureModel: services)));
                    },
                  ),
                );
              }))

import 'package:mincomparc/userpages/crud_structure/structure_details.dart';
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    title: Text(
                      direction.nom_structure ?? "",
                      style: const TextStyle(fontWeight: FontWeight.bold),
                    ),
                    subtitle: Text(
                      direction.description_structure ?? "",
